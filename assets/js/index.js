...
document.addEventListener('DOMContentLoaded', function () {
	...
	if (window.matchMedia("(min-width: 768px)").matches) {
		...
		document.querySelector("#projects .carousel-control-next").addEventListener("click", function () {
		...
		document.querySelector("#projects .carousel-control-prev").addEventListener("click", function () {
			if (scrollPosition > 0) {
				scrollPosition -= cardWidth;
				document.querySelector("#projects .carousel-inner").scroll({ left: scrollPosition, behavior: 'smooth' });
			}
